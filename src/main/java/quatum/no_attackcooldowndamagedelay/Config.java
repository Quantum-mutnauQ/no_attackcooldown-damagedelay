...
public class Config
{
    ...
    public static List<ResourceKey<DamageType>> damageTypesListValue = new ArrayList<>();
    ...
    static void onLoad(final ModConfigEvent event)
    {
        ...
        damageTypesListValue.add(DamageTypes.IN_FIRE);
        damageTypesListValue.add(DamageTypes.CACTUS);
        damageTypesListValue.add(DamageTypes.HOT_FLOOR);
        damageTypesListValue.add(DamageTypes.FREEZE);
        damageTypesListValue.add(DamageTypes.LAVA);
        damageTypesListValue.add(DamageTypes.FELL_OUT_OF_WORLD);
        damageTypesListValue.add(DamageTypes.SWEET_BERRY_BUSH);
        damageTypesListValue.add(DamageTypes.IN_WALL);
    }
}
